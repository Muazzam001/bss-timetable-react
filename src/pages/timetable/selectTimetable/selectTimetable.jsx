    ...
    <MainLayout>
      <div className="bg-gray-light-yellowish pt-10">
        <div className="container flex items-center flex-wrap gap-4">
          <InputField placeholder="ROC" className="h-10 lg:!w-38" />

          <InputField placeholder="Cluster 5" className="h-10 lg:!w-38" />
          ...
          <InputField placeholder="Lahore" className="h-10 lg:!w-38" />
