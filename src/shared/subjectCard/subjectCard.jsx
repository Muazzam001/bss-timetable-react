...
import Edit from "@/src/assets/index.jsx/icons/edit";
import Delete from "@/src/assets/index.jsx/icons/delete";
      ...
      <div className="flex justify-between w-full">
        ...
        <div className="flex justify-between w-2/5">
          ...
          <div className="flex gap-x-3 h-10">
            <span className="border-[1.5px] border-gray-medium rounded-full h-8 w-8 flex justify-center items-center">
