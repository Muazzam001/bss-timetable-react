...
const Modal = ({ isOpen, onClose, team }) => {
  return (
    <>
      ...
      <div
        className={`fixed top-0 right-0 min-h-screen overflow-y-auto w-[55%] border border-gray-medium transform transition-transform ease-in-out duration-700 bg-gray-light-bluish ${
          isOpen ? "translate-x-0" : "translate-x-full"
        } z-50`}
      >
        <div
          className="bg-white py-5 px-3 border-y border-slate-300 cursor-pointer"
          onClick={onClose}
        >
        ...
        <div className="flex flex-col gap-y-14 bg-white my-8 lg:mx-8 mx-2 border rounded-md border-gray-300 p-4 pt-10 overflow-y-auto">
